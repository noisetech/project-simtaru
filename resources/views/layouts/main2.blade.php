<!DOCTYPE html>
<html id="html" lang="id" class="scroll-smooth">
...
<head>
    ...
    <title>{{ isset($title) ? $title . ' | Simtaru Lampura' : 'Simtaru Lampura' }}</title>
...
<body class="text-sans">
    <nav class="fixed z-10 w-full px-4 py-3 bg-white border-gray-200 shadow xl:px-0">
        <div class="mx-auto xl:max-w-6xl 2xl:max-w-7xl">
            <div x-data="{ mobileMenu: false }" class="relative flex flex-wrap items-center justify-between mx-auto my-2">
                <a href="/" class="flex items-center">
                    <img src="{{ asset('img/logo/logo-lampura.png') }}" class="h-10 mr-2 md:h-12" alt="Flowbite Logo">
                    <svg class="h-8 text-gray-900 md:h-10" viewBox="0 0 1317 558" fill="none"
                ...
                <div class="flex md:order-2">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="hidden md:block">
                                <button type="button" class="btn-primary">Dashboard</button>
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="hidden md:block">
                                <button type="button" class="btn-primary">Login
                                    /
                                    Register</button>
                            </a>
                        @endauth
                    ...
                    <button x-on:click="mobileMenu=!mobileMenu" data-collapse-toggle="mobile-menu-4" type="button"
                        class="inline-flex items-center p-2 px-2 py-2 mr-3 text-sm font-medium text-center text-white rounded-lg md:hidden focus:outline-none bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 md:mr-0 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800"
                        aria-controls="mobile-menu-4" aria-expanded="false">
                        <svg x-show="!mobileMenu" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
                                clip-rule="evenodd"></path>
                        </svg>
                        <svg x-cloak x-show="mobileMenu" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                ...
                <div class="items-center justify-between hidden h-full md:flex">
                    <ul
                        class="flex flex-col h-full text-base font-normal text-gray-500 md:flex-row md:space-x-10 md:mt-0">
                        <li>
                            <a href="/" class="">Home</a>
                        </li>
                        <li>
                            <a href="/pengajuan" class="">Pengajuan</a>
                        </li>
                        <li>
                            <a href="/peta" class="">Peta</a>
                        </li>
                        <li>
                            <a href="/informasi" class="">Informasi</a>
                        </li>
                        <li>
                            <a href="/manual-book" class="">Manual
                                Book</a>
                        </li>
                    </ul>
                </div>
                <div x-cloak x-show="mobileMenu"
                    class="fixed bottom-0 left-0 right-0 z-50 flex justify-start overflow-x-hidden overflow-y-auto bg-white border-t-2 top-20 h-modal">
                    <ul class="px-10 mt-5 space-y-5 text-base font-normal text-gray-500">
                        <li>
                            <a href="/" class="">Home</a>
                        </li>
                        <li>
    ...
    <!--- Footer -->
    <footer class="px-4 mt-10 border-t shadow md:px-0">
        <div class="w-full">
            <div class="">
                <div class="container py-8 mx-auto text-center text-gray-700">
                    <p class="text-sm">
                        &copy; {{ date('Y') }} Sistem Informasi Tata Ruang Lampung Utara. All rights reserved.
                    </p>
                </div>
            </div>
        </div>
