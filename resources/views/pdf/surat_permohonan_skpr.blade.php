...
<head>
    ...
    <title>Surat Permohonan SKPR - {{ $pemohon->nama_lengkap }}</title>
    <style>
        @page {
    ...
    <table style="width: 100%; vertical-align:top">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Kepala Dinas PUPR Kab. Lampung Utara</td>
            </tr>
            <tr>
                <td>Perihal &nbsp;&nbsp;&nbsp;&nbsp;: Permohonan Rekomendasi</td>
                <td>c.q. Kepala Bidang Penataan Ruang</td>
            </tr>
            <tr>
                <td></td>
                <td>di - </td>
    ...
    <div style="padding-left: 1.5cm">
        ...
        <table style="width: 100%; vertical-align:top">
            ...
            <tbody>
                ...
                <tr>
                    <td style="vertical-align:top">Koordinat lokasi</td>
                    <td style="vertical-align:top">: </td>
                    <td style="vertical-align:top">{{ $pemohon->titik_koordinat }}</td>
                </tr>
            </tbody>
        </table>
        ...
        <ol style="text-align: justify">
            ...
            <li>Persetujuan tetangga yang dilampiri KTP yang menandatangani dan
                diketahui Kepala Desa/Lurah serta Camat.
            </li>
        </ol>
        <p style="text-align: justify">Apabila permohonan rekomendasi tersebut dikabulkan, maka kami sanggup dan
            bersedia
            memenuhi segala
            persyaratan-persyaratan yang ditentukan.</p>
